...
export const onboarding = defineOnboarding([
  {
    ...
    body: 'Describe a feature in Ideas, keep lasting behavior in Specifications, and give agents shared context in Documentation. Each surface starts with one clear next step.',
    chips: ['Ideas', 'Specifications', 'Documentation', 'Task Board'],
