...
import { EmptyState, ErrorBar, ListCard, Page, PageHeader, RowsSkeleton, Tabs } from '@moxxy/companion-sdk/ui';
 ...
 * this is the archive, paged through the server's cursor.
 */
export function InboxPage(): React.JSX.Element {
  const { items, unread, scope, loading, error, hasMore, loadMore, markRead, markAllRead } = useNotifications();
