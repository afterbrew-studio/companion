...
- `profiles/slim.json` is the shipped default: 16 modules (core, workspace,
  integrations, operate, model-router, code, coderabbit, jira, notify,
  workbench and admin, plus plan + board + automations, contribution quality
  and Companion Desk).
