...
- `profiles/slim.json` is the shipped default: 13 modules (core, workspace,
  integrations, operate, code, coderabbit, jira, notify, workbench and admin,
  plus plan + board + automations, which carry the durable contributor
