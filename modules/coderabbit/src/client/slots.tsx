...
/**
 * CodeRabbit's mark, inline so an air-gapped instance draws it like any other
 * pixel it ships. It is CodeRabbit's trademark, used only to identify their
 * integration; the path is their single-path mark from simple-icons (CC0),
 * filled with the brand colour they publish.
 */
function CodeRabbitMark(): React.JSX.Element {
  return (
    <svg className="size-5" viewBox="0 0 24 24" role="img" aria-label="CodeRabbit" fill="#FF570A">
...
export const slots = defineSlots([
  { slot: 'integrations.provider.coderabbit.cli.icon', key: 'coderabbit-mark', component: CodeRabbitMark },
]);
