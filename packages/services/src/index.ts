 ...
 * or store is made of: the SQLite handle, logging, request-scoped user context,
 * tolerant model JSON extraction, and shared SQL/JSON helpers. NOT the framework
 * (that is `@moxxy/companion-core`) and NOT concrete domain services (those live
 * in modules).
 */
